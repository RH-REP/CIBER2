...
class CF_Class:
    def __init__(self, eps_shelf,ls_irradiance_class,OD,arm_name) :
        ...
        # transparent_ls = 0.4
        # self.cf = self.ls_irradiance_reduced_by_ND_ip_to_lvf/self.eps_lvf/math.pi * transparent_ls * 1.2
        self.cf = self.ls_irradiance_reduced_by_ND_ip_to_lvf/self.eps_lvf/math.pi * 0.76 * 1.2
